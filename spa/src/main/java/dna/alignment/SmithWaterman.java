 ...
 * http://www.cs.utexas.edu/~mobios/cs329e/rosetta/src/SimpleChaining.java
 */
...
public class SmithWaterman {
    ...
    public static void main(String[] args) {
    	SmithWaterman sw = new SmithWaterman("MKNLASREVNIYVNGKLV", "QMASREVNIYVNGKL");
    	System.out.println("identity = " + sw.getAlignmentScore());
    }
